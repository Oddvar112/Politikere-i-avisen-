...
public interface KandidatLinkRepository extends JpaRepository<KandidatLink, Long> {
     ...
     * Returnerer én rad per kandidat med navn, parti, alder, kjønn, valgdistrikt(er) og alle lenker som kommaseparerte strenger.
     * @return Liste med kandidatnavn, parti, alder, kjønn, valgdistrikt(er) og deres samlede lenker
     */
